          ...
          children: [
            Stack(
              children: [
                ...
                if (controller.questionList.length == 0)
                  SizedBox()
                else
                  Padding(
                      ...
                      children: [
                        ...
                        ...List<Widget>.generate(
                            controller.questionList.isNotEmpty &&
                                ...
                                ? controller
                                    .questionList[controller.counter.value - 1]
                                    .answers!
                                    .length
                                : 0, (index) {
...
// Inside the List<Widget>.generate method
            ...
            // Text(
            //     '${controller.selectedAnswers[controller.questionText.value]!['index']}'),
            // Text(
            // '${controller.selectedAnswers.values.map((answerMap) => answerMap['index'].toString()).join(', ')}')
            Obx(
              () => Text(
                '${controller.selectedAnswers[controller.questionText.value] ?? 'No answers selected'}',
              ),
            )
          ],
        ),
