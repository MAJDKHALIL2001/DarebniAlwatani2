      ...
      body: RefreshIndicator(
        ...
        child: ListView(children: [
          TitleWiget(
              ...
              text: "${collegeName}",
              color:
                  kind == 'ماستر' ? AppColors.blueColor : AppColors.mainColor),
          Padding(
                ...
                children: [
                  Padding(
                    ...
                    child: controller.isloading.value
                        ...
                        : controller.listImage.length == 0
                            ? CustomText(text: 'لا يوجد صور بعد')
                            : CustomCarous(
                                images: controller.listImage,
                  ...
                  Obx(() {
                    return controller.listImage.length == 0
                        ? SizedBox()
                        : CustomDots(
                            dotsCount: controller.listImage.length,
